...
| **Nothing OS Version** | **Build No.**     | **Incremental OTA**                                 | **Full OTA**                           | **OTA Images**          |
|------------------|-------------------|-----------------------------------------------------|-------------------------------------------------------|-------------------------|
| 3.0 | PacmanPro-V3.0-250207-2041 | PacmanPro-V3.0-241226-1537 -> [PacmanPro-V3.0-250207-2041](https://android.googleapis.com/packages/ota-api/package/ea9af989918db06e6510fff9d59552d5a429191b.zip) | N/A | [Here](https://github.com/spike0en/nothing_archive/releases/tag/3.0.0-pacmanpro.250207) |
